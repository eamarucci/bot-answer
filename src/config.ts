...
const configSchema = z.object({
  ...
  llm: z.object({
    ...
    baseSystemPrompt: z.string().default("LIMITE ABSOLUTO: 4 frases. PROIBIDO: listas, bullets, enumeracoes, mais de 4 frases. Se a resposta exigir mais, resuma ou pergunte o que o usuario quer saber especificamente. Seja direto. Portugues."),
    defaultSystemPrompt: z.string().default("Voce e um assistente de chat prestativo."),
  }),
...
function loadConfig() {
  const rawConfig = {
    ...
    llm: {
      ...
      baseSystemPrompt: process.env.BASE_SYSTEM_PROMPT || "LIMITE ABSOLUTO: 4 frases. PROIBIDO: listas, bullets, enumeracoes, mais de 4 frases. Se a resposta exigir mais, resuma ou pergunte o que o usuario quer saber especificamente. Seja direto. Portugues.",
      defaultSystemPrompt: process.env.DEFAULT_SYSTEM_PROMPT || "Voce e um assistente de chat prestativo.",
    },
    context: {
